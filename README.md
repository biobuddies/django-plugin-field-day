...
print(
    f'{iso_8601[:-32]}{iso_8601[-32:-22]} {iso_8601[-21:-16]}{iso_8601[-6:]}'
    .replace('+00:00', ' Z')
)
```
...
qs = User.objects.annotate(
    iso_8601=Concat(
        ...
        Value('.'),
        LPad(Cast(Cast(Random() * 99, output_field=IntegerField()), output_field=CharField()), 2, Value('0')),
        Value(' '),
